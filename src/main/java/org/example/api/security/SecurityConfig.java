    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(new RegexRequestMatcher("^/api/withdraws/card/\\d+$", "GET")).hasAnyRole("USER")
                        .requestMatchers(new RegexRequestMatcher("^/api/withdraws/account/\\d+$", "GET")).hasAnyRole("USER")
                        ...
                        .requestMatchers(new RegexRequestMatcher("^/api/account/update/isInDebt/\\d+$", "PATCH")).hasAnyRole("USER","ADMIN")
                        .requestMatchers(new RegexRequestMatcher("^/api/account/update/isBlocked/\\d+$", "PATCH")).hasAnyRole("USER","ADMIN")
                        .requestMatchers(new RegexRequestMatcher("^/api/account/update/accountType/\\d+$", "PATCH")).hasAnyRole("ADMIN")
                        .requestMatchers(new RegexRequestMatcher("^/api/account/update/expirationDate/\\d+$", "PATCH")).hasAnyRole("USER","ADMIN")
                        .requestMatchers(new RegexRequestMatcher("^/api/card/update/isBlocked/\\d+$", "PATCH")).hasAnyRole("USER","ADMIN")
                        .requestMatchers(new RegexRequestMatcher("^/api/card/update/dailyLimit/\\d+$", "PATCH")).hasAnyRole("USER","ADMIN")
                        .requestMatchers(new RegexRequestMatcher("^/api/card/update/monthlyLimit/\\d+$", "PATCH")).hasAnyRole("USER","ADMIN")
                        ...
                        .requestMatchers(new RegexRequestMatcher("^/api/customer/delete/\\d+$", "DELETE")).hasRole("ADMIN")
                        .requestMatchers(new RegexRequestMatcher("^/api/withdraws/delete/card/\\d+$", "DELETE")).hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/customers").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/withdraws").hasAnyRole("USER")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/withdraw/new").hasRole("USER")
