...
(170, 200.0, 161, TRUE, FALSE, TIMESTAMP '2024-10-21 12:55:23.187724', TIMESTAMP '2025-10-21 12:55:23.187724', 'BUSINESS_ACCOUNT'),
(171, -200.0, 161, FALSE, TRUE, TIMESTAMP '2024-10-21 12:57:54.187724', TIMESTAMP '2025-10-21 12:57:54.187724', 'BUSINESS_ACCOUNT'),
(172, -200.0, 161, TRUE, TRUE, TIMESTAMP '2024-10-21 13:00:08.187724', TIMESTAMP '2025-10-21 13:00:08.187724', 'BUSINESS_ACCOUNT');


CREATE CACHED TABLE "PUBLIC"."Card"(
    "account_id" INTEGER NOT NULL,
    "cardId" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 3) NOT NULL,
...
(1, 'john.doe@example.com', 'John', 'password123', 'Doe', 'USER'),
(2, 'jane.smith@example.com', 'Jane', 'securepass', 'Smith', 'USER'),
(33, 'julia@sanz.com', 'Julia', 'hola', 'Sanz', 'USER'),
(65, 'franro@email.es', 'Fran', '1234', 'Rodriguez', 'USER'),
(66, 'jorgejimo@email.es', 'Jorge', '2432762', 'Jimenez', 'USER'),
(97, 'customer@example.com', 'Jane', 'password123', 'Doe', 'USER'),
(129, 'pepeG@email.es', 'pepito', '4466', 'grillo', 'USER'),
(161, 'csan@email.com', 'carlos', '2334', 'sanchez', 'USER'),
(193, 'new.user@example.com', 'New', 'newpassword', 'User', 'USER'),
(353, 'testuser@example.com', 'John', 'password123', 'Doe', 'USER'),
...
CREATE CACHED TABLE "PUBLIC"."Transfer"(
    ...
    "transferId" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 69) NOT NULL,
